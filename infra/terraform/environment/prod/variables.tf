...
variable "cors_allow_origin" {
  ...
  type        = string
  default     = "https://your-production-domain.example.com"
}
...
variable "cognito_user_pool_name" {
  ...
  type        = string
  default     = "saas-template-prod-users"
}

variable "cognito_user_pool_client_name" {
  description = "Cognito user pool client name."
  type        = string
  default     = "saas-template-prod-client"
}
...
variable "cognito_callback_urls" {
  ...
  type        = list(string)
  default     = ["https://localhost:3000/api/auth/callback/cognito"]
}
...
variable "dynamodb_tables" {
  ...
  default = {
    app = {
      table_name = "saas-template-prod-app"
      hash_key   = "pk"
      range_key  = "sk"
      attributes = [
        { name = "pk", type = "S" },
...
variable "s3_buckets" {
  ...
  default = {
    primary = {
      bucket_name = "saas-template-prod-data-001"
    }
    artifacts = {
      bucket_name = "saas-template-prod-lambda-artifacts-001"
    }
  }
}
