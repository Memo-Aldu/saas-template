...
variable "cognito_user_pool_name" {
  ...
  type        = string
  default     = "saas-template-dev-users"
}

variable "cognito_user_pool_client_name" {
  description = "Cognito user pool client name."
  type        = string
  default     = "saas-template-dev-client"
}
...
variable "dynamodb_tables" {
  ...
  default = {
    app = {
      table_name = "saas-template-dev-app"
      hash_key   = "pk"
      range_key  = "sk"
      attributes = [
        { name = "pk", type = "S" },
...
variable "s3_buckets" {
  ...
  default = {
    primary = {
      bucket_name = "saas-template-dev-data-001"
    }
    artifacts = {
      bucket_name = "saas-template-dev-lambda-artifacts-001"
    }
  }
}
